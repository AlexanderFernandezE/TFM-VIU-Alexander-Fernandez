...
############################################
data1 <- read_excel(
  "C:/Users/afernandeze/Documents/Consolidado_Noticias_2020_2024.xlsx"
)
...
data1 <- read_excel("Consolidado_Noticias_2020_2024.xlsx")
...
archivo <- "Consolidado_Noticias_2020_2024.xlsx"
...
frecuencia_mapa <- data.frame(
  ...
  frecuencia_robo = c(
    1,4,1,0,3,0,6,0,12,6,2,2,4,5,3,0,10,0,2,2,1,
    13,0,0,8,1,0,1,0,4,3,14,4,3,13,4,1,0,1,0,1,4,0
  )
)
